...
public class SearchQa extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String searchName = new String(req.getParameter("search").getBytes("ISO-8859-1"), "UTF-8");
		System.out.println("값 받아와지나 확인 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>" + searchName);
        ...
        int totalCount = qaService.searchCountList(searchName);
        ...
        // 범위 별 게시물 가져오기
        List<BoardQaVO> list = qaService.searchQa(map);
        ...
        req.getRequestDispatcher("/views/qa/qaSearchList.jsp").forward(req, resp);
	}
