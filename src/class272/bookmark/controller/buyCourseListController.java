...
public class buyCourseListController extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<CourseVO> CList = bookService.buyCourseList(memId);
		req.setAttribute("CList", CList);
		
		req.getRequestDispatcher("/views/member/buyList.jsp").forward(req, resp);
	}
